        ...
        <div className="container">
          <div className="whatsapp-cta-content">
            <div className="whatsapp-cta-text">
              <h2>¿Prefieres agendar directamente?</h2>
              <p>Escríbeme por WhatsApp y coordinamos tu cita al instante.</p>
            </div>
            <a
